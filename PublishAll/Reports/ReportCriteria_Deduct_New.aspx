<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/AdminMaster.master" AutoEventWireup="true" CodeFile="ReportCriteria_Deduct_New.aspx.cs" Inherits="Reports_ReportCriteria_New" %>
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <%-- <div class="form-group" id="billno" runat="server">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                         ...
                                         <asp:TextBox ID="txtBillno" runat="server"  Text=""  CssClass="form-control col-md-7 col-xs-12"  MaxLength="6" required="required"></asp:TextBox>
                                    </div>
                                ...
                                <div class="form-group" id="div1" runat="server">
                                    <label class="control-label col-md-4 col-sm-4 col-xs-12" for="first-name">
                                       Select Deduction <span class="required">*</span>
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                           
                                        <asp:DropDownList ID="cmbDeductRpt" runat="server" CssClass="form-control col-md-7 col-xs-12"  >
                                            <asp:ListItem>Select...</asp:ListItem>
                                            <asp:ListItem Value="Incometax">Income Tax</asp:ListItem>
                                            <asp:ListItem Value="CUG">CUG </asp:ListItem>
                                            <asp:ListItem Value="GIS">GIS </asp:ListItem>
                                            <asp:ListItem Value="OtherDed">Other Deduction </asp:ListItem>
                                        </asp:DropDownList>
                              <asp:DropDownList ID="cmbDeputationDeduct" runat="server" CssClass="form-control col-md-7 col-xs-12"  >
                                            <asp:ListItem>Select...</asp:ListItem>
                                            <asp:ListItem Value="GPFRegular">GPF Regular</asp:ListItem>
                                            <asp:ListItem Value="OtherDeduction">Other Deduction</asp:ListItem>
                                            <asp:ListItem Value="GISDeduction">GIS Deduction </asp:ListItem>
                                            <asp:ListItem Value="Incometax">Income Tax</asp:ListItem>
                                  <%--              <asp:ListItem Value="CUGDeduction">CUG </asp:ListItem>--%>
                                        </asp:DropDownList>
                                    </div>
                                </div></div>
                  ...
                  <%--          <div class="col-md-6 col-sm-6 col-xs-12"  style =" display :none">
                                <div class="form-group" id="EmpName" runat="server" >
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div id="divemplist" runat="server" style=" border-style:ridge; overflow:scroll; height:35px">
                            ...
                            <div class="clearfix"> </div>                      
                             ...
                             <div id="divchkAll" runat="server" class="col-md-6 col-sm-6 col-xs-12 col-md-offset-8">

                                 <asp:CheckBox ID="chkall" runat="server" Text="Checked All" />
                            </div>

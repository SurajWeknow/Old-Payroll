        ...
        <div class="form-horizontal form-label-left">
            ...
            <div class="page-title">
                <div class="title_left">
                    <h3>
                        <asp:Label ID="lblTitle1" runat="server" ForeColor="#33363a"></asp:Label>
                    </h3>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>
                                <asp:Label ID="lbltitle" runat="server" ForeColor="#c74040"></asp:Label>
                            ...
                            <asp:CheckBox ID="chkAllSlip" Text="Show All" runat="server" 
                                    AutoPostBack="True" oncheckedchanged="chkAllSlip_CheckedChanged" />
                                       <br />   
                                        <asp:CheckBox ID="chkRegEmp" Text="Regular Employee" runat="server"  AutoPostBack="True" 
                                   oncheckedchanged="chkRegEmp_CheckedChanged"  />                                
                                        <asp:CheckBox ID="chkSuspended" Text="Suspended Employee" runat="server"   />
                                    </div>
                                  ...
                                  <div class="col-md-6 col-sm-6 col-xs-12">
                                           <div class="form-group" id="Div1" runat="server">
                                               <label class="control-label col-md-4 col-sm-4 col-xs-12" for="first-name">
                                                   Emp. Code<span class="required"></span>
                                               </label>
                                               <div class="col-md-6 col-sm-6 col-xs-12">
                                                   <asp:TextBox ID="txtCode" runat="server" Text="" CssClass="form-control col-md-7 col-xs-12"
                                                       MaxLength="6"  AutoPostBack="true" ontextchanged="txtCode_TextChanged"></asp:TextBox>
                                               </div>
                                           </div>
                                       </div>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group" id="EmpName" runat="server" >
                                    ...
                                    <div id="divemplist" runat="server" style=" border-style:ridge; overflow:scroll; padding-left:5px; height:35px">
                                     <asp:CheckBoxList ID="chkEmployeeName" runat="server" Width="82px" >
                                ...
                                <div class="form-group" id="Div2" runat="server" >
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">                            
                                  <asp:CheckBox ID="chkisAgreement" runat="server" Text="  Agreement List" Visible="false" /> 
                                    </div>
                                </div>
                                </div>
                            ...
                            <div class="ln_solid">
                             ...
                             <div class="form-group">
                                <div class="col-md-12 col-sm-12 col-xs-12 col-md-offset-5">
                                    <asp:Button ID="btnCancel" runat="server" Text="Cancel" CssClass="btn btn-primary" Visible="false" onclick="btnCancel_Click" />
                                    <asp:Button ID="btnSearch" runat="server" Text="Go" CssClass="btn btn-success" onclick="btnSearch_Click" />
                                    <asp:Button ID="btnExcel" runat="server" Text="Import to Excel" CssClass="btn btn-danger" onclick="btnExcel_Click"   />                                        
                                    <asp:Button ID="btnBankList" runat="server" Text="BankList All"   Visible="false" CssClass="btn btn-warning" onclick="btnBankList_Click"  />
                                    <asp:Button ID="btnRTGS" runat="server" Text="RTGS List All"   Visible="false"  CssClass="btn btn-success" onclick="btnRTGS_Click"  />
                                    <asp:Button ID="btnBankListExcel" runat="server" Text="BankList All in Excel"  Visible="false"
                                        CssClass="btn btn-primary" onclick="btnBankListExcel_Click"/>
                                </div>
                            </div>

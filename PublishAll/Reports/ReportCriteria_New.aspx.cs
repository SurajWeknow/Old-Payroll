...
public partial class Reports_ReportCriteria_New : System.Web.UI.Page
{
       ...
       // String RequestedPage = Request.PhysicalPath.Replace(Request.PhysicalApplicationPath, "google.com");
        ...
        if (!Page.IsPostBack)
        {
            ...
            else if (RptType == 9)
            {
                ...
                Div1.Visible = false;
                btnBankListExcel.Visible = true; btnRTGS.Visible = true;
            }
            else if (RptType == 12)
            {
            ...
            else if (RptType == 18)  //  Bonus Report finyear wise
            {
                ...
                btnBankList.Visible = true;
                btnBankListExcel.Visible = true;
                chkisAgreement.Visible = true; btnRTGS.Visible = true;
            }
            else if (RptType == 19)
            {
    ...
    protected void btnBankList_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (chkisAgreement.Checked == true)
            {
                ...
                {
                    ScriptManager.RegisterStartupScript(Page, Page.GetType(), "newWindow", "window.open('../Reports/AppReportViewer_New.aspx?UnitKey=" + postingkey + "&MonthKey=" + cmbMonth.SelectedValue + "&MonthText=" + cmbMonth.SelectedItem.Text + "&YearKey=" + cmbYear.SelectedValue + "&YearText=" + cmbYear.SelectedItem.Text + "&UnitName=" + cmbPosting.SelectedItem.Text + "&EmpKey=" + key + "&Billno=" + txtBillno.Text + "&Type=Bank&isAgreemnt=Agreement&repno=19','_blank','status=1,toolbar=0,menubar=0,location=1,scrollbars=1,resizable=1,width=980,height=800');FillEmployee();", true);
                }
            }
            else
            {
                if (RptType == 18)   //---------------- For Bonus Report Banklist
                {
                    ScriptManager.RegisterStartupScript(Page, Page.GetType(), "newWindow", "window.open('../Reports/AppReportViewer_New.aspx?UnitKey=" + postingkey + "&MonthKey=" + cmbMonth.SelectedValue + "&MonthText=" + cmbMonth.SelectedItem.Text + "&YearKey=" + cmbYear.SelectedValue + "&YearText=" + cmbYear.SelectedItem.Text + "&UnitName=" + cmbPosting.SelectedItem.Text + "&EmpKey=" + key + "&Billno=" + txtBillno.Text + "&Type=Bank&isAgreemnt=Regular&repno=19','_blank','status=1,toolbar=0,menubar=0,location=1,scrollbars=1,resizable=1,width=980,height=800');FillEmployee();", true);
                }
            }
    ...
    protected void btnBankListExcel_Click(object sender, EventArgs e)
    {
        try
        {
         ...
         {
             ScriptManager.RegisterStartupScript(Page, Page.GetType(), "newWindow", "window.open('../Reports/AppReportViewer_New.aspx?UnitKey=" + postingkey + "&MonthKey=" + cmbMonth.SelectedValue + "&MonthText=" + cmbMonth.SelectedItem.Text + "&YearKey=" + cmbYear.SelectedValue + "&YearText=" + cmbYear.SelectedItem.Text + "&UnitName=" + cmbPosting.SelectedItem.Text + "&EmpKey=" + key + "&Type=Bank&repno=290','_blank','status=1,toolbar=0,menubar=0,location=1,scrollbars=1,resizable=1,width=980,height=800');FillEmployee();", true);
         }
    ...
    protected void btnRTGS_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (RptType == 9)   //---------------- For Holiday Arrear RTGS
            {
                ScriptManager.RegisterStartupScript(Page, Page.GetType(), "newWindow", "window.open('../Reports/AppReportViewer_New.aspx?UnitKey=" + postingkey + "&MonthKey=" + cmbMonth.SelectedValue + "&MonthText=" + cmbMonth.SelectedItem.Text + "&YearKey=" + cmbYear.SelectedValue + "&YearText=" + cmbYear.SelectedItem.Text + "&UnitName=" + cmbPosting.SelectedItem.Text + "&EmpKey=" + key + "&Type=RTGS&repno=290','_blank','status=1,toolbar=0,menubar=0,location=1,scrollbars=1,resizable=1,width=980,height=800');FillEmployee();", true);
            }
            if (RptType == 17)   //---------------- For DA Arrear RTGS
            {
                ScriptManager.RegisterStartupScript(Page, Page.GetType(), "newWindow", "window.open('../Reports/AppReportViewer_New.aspx?UnitKey=" + postingkey + "&MonthKey=" + cmbMonth.SelectedValue + "&MonthText=" + cmbMonth.SelectedItem.Text + "&YearKey=" + cmbYear.SelectedValue + "&YearText=" + cmbYear.SelectedItem.Text + "&UnitName=" + cmbPosting.SelectedItem.Text + "&EmpKey=" + key + "&Billno=" + txtBillno.Text + "&Type=RTGS&repno=17','_blank','status=1,toolbar=0,menubar=0,location=1,scrollbars=1,resizable=1,width=980,height=800');FillEmployee();", true);
            }
            if (RptType == 18)   //---------------- For Bonus Report RTGSlist
            {
                if(chkisAgreement.Checked=true)
                    ScriptManager.RegisterStartupScript(Page, Page.GetType(), "newWindow", "window.open('../Reports/AppReportViewer_New.aspx?UnitKey=" + postingkey + "&MonthKey=" + cmbMonth.SelectedValue + "&MonthText=" + cmbMonth.SelectedItem.Text + "&YearKey=" + cmbYear.SelectedValue + "&YearText=" + cmbYear.SelectedItem.Text + "&UnitName=" + cmbPosting.SelectedItem.Text + "&EmpKey=" + key + "&Billno=" + txtBillno.Text + "&Type=RTGS&isAgreemnt=Agreement&repno=19','_blank','status=1,toolbar=0,menubar=0,location=1,scrollbars=1,resizable=1,width=980,height=800');FillEmployee();", true);
                   else
                ScriptManager.RegisterStartupScript(Page, Page.GetType(), "newWindow", "window.open('../Reports/AppReportViewer_New.aspx?UnitKey=" + postingkey + "&MonthKey=" + cmbMonth.SelectedValue + "&MonthText=" + cmbMonth.SelectedItem.Text + "&YearKey=" + cmbYear.SelectedValue + "&YearText=" + cmbYear.SelectedItem.Text + "&UnitName=" + cmbPosting.SelectedItem.Text + "&EmpKey=" + key + "&Billno=" + txtBillno.Text + "&Type=RTGS&isAgreemnt=Regular&repno=19','_blank','status=1,toolbar=0,menubar=0,location=1,scrollbars=1,resizable=1,width=980,height=800');FillEmployee();", true);
            }
